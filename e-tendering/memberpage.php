...
<div class ="loginhead">
        ...
        <div id = "membersmenu">
          ...
          <div id ="available_tenders">
                  <?php
                  $sql ="SELECT * FROM Tender_details where bid=0 and pending =0 ORDER BY tender_id";
                  ...
                  // set table headers
                  echo "<tr><th>Tender ID</th><th>Tender Info</th><th>Tender Cost</th><th>Client</th><th>Location</th><th>Closing Date</th><th>click</th>";
                  ...
                  echo "<td><a href='seemore.php?id=" . $tender['tender_id'] . "'>Description</a></td>";
