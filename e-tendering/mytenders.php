...
<div class ="loginhead">
        ...
        <div id = "membersmenu">
          ...
          <div = id ="available_tenders">
            <label style="color:green">My Tenders</label><br><br>
            <?php
            $Userid=$_SESSION['memberID'];
                  $sql ="SELECT * FROM Tender_details where bid=1 and pending =1 and UserID= $Userid ORDER BY tender_id";
                  ...
                  // set table headers
                  echo "<tr><th>Tender ID</th><th>Tender Info</th><th>Tender Cost</th><th>Client</th><th>Location</th><th>Closing Date</th></tr>";
