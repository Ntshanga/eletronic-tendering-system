...
<?php
if($result = $DBcon->query("SELECT * FROM Tender_details where  bid=1 and pending=0  order by tender_id")){
...
// set table headers
echo "<tr><th>Tender ID</th><th>Supplier ID</th><th>Tender Info</th><th>Tender Cost</th><th>Client</th><th>Location</th><th>Closing Date</th><th></th><th></th><th></th></tr>";
...
echo "<td><a href='acceptRequest.php?id=" . $row->tender_id . "'>Approve</a></td>";
echo "<td><a href='reject.php?id=" . $row->tender_id . "'>Reject</a></td>";
echo "</tr>";
}
...
{
echo "all tenders have been approved or rejected!!";
