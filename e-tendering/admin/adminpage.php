...
<?php
if($result = $DBcon->query("SELECT * FROM Tender_details where bid=0 and pending= 0 ORDER BY tender_id")){
...
// set table headers
echo "<tr><th>Tender ID</th><th>Tender Info</th><th>Tender Cost</th><th>Client</th><th>Location</th><th>Closing Date</th><th></th><th></th></tr>";
...
echo "<td><a href='posttender.php?id=" . $row->tender_id . "'>Edit</a></td>";
...
{
echo "No Posted Tender! or all tenders have been taken!!";
